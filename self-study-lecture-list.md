# CWT ML/AI beginner (mostly freshmen) lecture guide list 📚
These lectures are typically used as intro for beginners who are getting started to study Machine Learning, and AI.

## Getting started to ML basic (mandatory for beginners)
### 1. Easy basic tutorial of concepts

[Real basic lecture (Korean)](https://www.youtube.com/playlist?list=PLfLgtT94nNq1DrREU_qG2w4yd2ZzJb-FG)
...
## Additional lectures
This is fork of [AIVS pre-session online lectures](https://github.com/powersimmani/AIVS-Online-lecture-list/blob/main/readme.md).
They are not mandatory for the club activity, but please look through if you feel you need them.
